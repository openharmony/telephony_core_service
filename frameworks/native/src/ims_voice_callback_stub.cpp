...
namespace OHOS {
namespace Telephony {
int ImsVoiceCallbackStub::OnRemoteRequest(
    uint32_t code, MessageParcel &data, MessageParcel &reply, MessageOption &option)
{
    TELEPHONY_LOGI("ImsVoiceCallbackStub Enter!");
...
int32_t ImsVoiceCallbackStub::OnImsStateCallback(const ImsRegInfo &info)
{
    OnImsVoiceStateChange(info);
    return SUCCESS;
}

void ImsVoiceCallbackStub::OnImsVoiceStateChange(const ImsRegInfo &info) {}
}  // namespace Telephony
}  // namespace OHOS
