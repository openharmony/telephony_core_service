...
#ifndef CANCEL_SESSION_CALLBACK_H
#define CANCEL_SESSION_CALLBACK_H
...
namespace OHOS {
namespace Telephony {
class CancelSessionCallback : public IEsimServiceCallbackStub {
public:
    explicit CancelSessionCallback(AsyncCancelSession *context);
