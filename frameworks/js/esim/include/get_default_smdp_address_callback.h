...
#ifndef GET_DEFAULT_SMDP_ADDRESS_CALLBACK_H
#define GET_DEFAULT_SMDP_ADDRESS_CALLBACK_H
...
namespace OHOS {
namespace Telephony {
class GetDefaultSmdpAddressResultCallback : public IEsimServiceCallbackStub {
public:
...
#endif // GET_DEFAULT_SMDP_ADDRESS_CALLBACK_H