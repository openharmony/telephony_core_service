...
namespace OHOS {
namespace Telephony {
GetSupportedPkidsResultCallback::GetSupportedPkidsResultCallback(AsyncContext<std::string>  *context)
    : asyncContext_(context)
{}

void GetSupportedPkidsResultCallback::OnGetSupportedPkids(const std::string &result, const int32_t errorCode)
{
