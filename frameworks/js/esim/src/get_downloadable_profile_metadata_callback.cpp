...
namespace OHOS {
namespace Telephony {
GetDownloadableProfileMetadataResultCallback::GetDownloadableProfileMetadataResultCallback(
    AsyncProfileMetadataInfo *context) : asyncContext_(context) {}

void GetDownloadableProfileMetadataResultCallback::OnGetDownloadableProfileMetadata(
