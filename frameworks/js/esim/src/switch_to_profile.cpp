...
namespace OHOS {
namespace Telephony {
SwitchToProfileResultCallback::SwitchToProfileResultCallback(AsyncSwitchProfileInfo *context) : asyncContext_(context)
{}

void SwitchToProfileResultCallback::OnSwitchToProfile(const int32_t &result, const int32_t errorCode)
{
