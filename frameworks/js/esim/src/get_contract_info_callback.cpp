...
namespace OHOS {
namespace Telephony {
GetContractInfoResultCallback::GetContractInfoResultCallback(AsyncGetContractInfo  *context) : asyncContext_(context)
{}

void GetContractInfoResultCallback::OnGetContractInfo(const std::string &result, const int32_t errorCode)
{
