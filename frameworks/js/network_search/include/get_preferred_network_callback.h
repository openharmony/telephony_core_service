...
#ifndef GET_PREFERRED_NETWORK_CALLBACK_H
#define GET_PREFERRED_NETWORK_CALLBACK_H
...
public:
    GetPreferredNetworkCallback(PreferredNetworkModeContext *asyncContext);
...
#endif // GET_PREFERRED_NETWORK_CALLBACK_H