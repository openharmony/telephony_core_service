...
{
    napi_property_descriptor desc[] = {
        DECLARE_NAPI_WRITABLE_FUNCTION("unlockPin", UnlockPin),
        DECLARE_NAPI_WRITABLE_FUNCTION("unlockPuk", UnlockPuk),
        DECLARE_NAPI_WRITABLE_FUNCTION("alterPin", AlterPin),
        DECLARE_NAPI_WRITABLE_FUNCTION("setLockState", SetLockState),
        DECLARE_NAPI_WRITABLE_FUNCTION("unlockPin2", UnlockPin2),
        DECLARE_NAPI_WRITABLE_FUNCTION("unlockPuk2", UnlockPuk2),
        DECLARE_NAPI_WRITABLE_FUNCTION("alterPin2", AlterPin2),
        DECLARE_NAPI_WRITABLE_FUNCTION("getLockState", GetLockState),
        DECLARE_NAPI_WRITABLE_FUNCTION("unlockSimLock", UnlockSimLock),
    };
...
{
    napi_property_descriptor desc[] = {
        DECLARE_NAPI_WRITABLE_FUNCTION("queryIccDiallingNumbers", QueryIccDiallingNumbers),
        DECLARE_NAPI_WRITABLE_FUNCTION("addIccDiallingNumbers", AddIccDiallingNumbers),
        DECLARE_NAPI_WRITABLE_FUNCTION("delIccDiallingNumbers", DelIccDiallingNumbers),
        DECLARE_NAPI_WRITABLE_FUNCTION("updateIccDiallingNumbers", UpdateIccDiallingNumbers),
    };
    return napi_define_properties(env, exports, sizeof(desc) / sizeof(desc[0]), desc);
}
...
{
    napi_property_descriptor desc[] = {
        DECLARE_NAPI_WRITABLE_FUNCTION("setDefaultVoiceSlotId", SetDefaultVoiceSlotId),
        DECLARE_NAPI_WRITABLE_FUNCTION("getDefaultVoiceSlotId", GetDefaultVoiceSlotId),
        DECLARE_NAPI_WRITABLE_FUNCTION("getDefaultVoiceSimId", GetDefaultVoiceSimId),
        DECLARE_NAPI_WRITABLE_FUNCTION("getVoiceMailIdentifier", GetVoiceMailIdentifier),
        DECLARE_NAPI_WRITABLE_FUNCTION("getVoiceMailNumber", GetVoiceMailNumber),
        DECLARE_NAPI_WRITABLE_FUNCTION("getVoiceMailCount", GetVoiceMailCount),
        DECLARE_NAPI_WRITABLE_FUNCTION("setVoiceMailInfo", SetVoiceMailInfo),
    };
    return napi_define_properties(env, exports, sizeof(desc) / sizeof(desc[0]), desc);
}
...
{
    napi_property_descriptor desc[] = {
        DECLARE_NAPI_WRITABLE_FUNCTION("getISOCountryCodeForSim", GetISOCountryCodeForSim),
        DECLARE_NAPI_WRITABLE_FUNCTION("getISOCountryCodeForSimSync", GetISOCountryCodeForSimSync),
        DECLARE_NAPI_WRITABLE_FUNCTION("getSimOperatorNumeric", GetSimOperatorNumeric),
        DECLARE_NAPI_WRITABLE_FUNCTION("getSimOperatorNumericSync", GetSimOperatorNumericSync),
        DECLARE_NAPI_WRITABLE_FUNCTION("getSimSpn", GetSimSpn),
        DECLARE_NAPI_WRITABLE_FUNCTION("getSimSpnSync", GetSimSpnSync),
        DECLARE_NAPI_WRITABLE_FUNCTION("getSimState", GetSimState),
        DECLARE_NAPI_WRITABLE_FUNCTION("getSimStateSync", GetSimStateSync),
        DECLARE_NAPI_WRITABLE_FUNCTION("getCardType", GetCardType),
        DECLARE_NAPI_WRITABLE_FUNCTION("getCardTypeSync", GetCardTypeSync),
        DECLARE_NAPI_WRITABLE_FUNCTION("getSimIccId", GetSimIccId),
        DECLARE_NAPI_WRITABLE_FUNCTION("getIMSI", GetIMSI),
        DECLARE_NAPI_WRITABLE_FUNCTION("isOperatorSimCard", IsOperatorSimCard),
        DECLARE_NAPI_WRITABLE_FUNCTION("hasSimCard", HasSimCard),
        DECLARE_NAPI_WRITABLE_FUNCTION("hasSimCardSync", HasSimCardSync),
        DECLARE_NAPI_WRITABLE_FUNCTION("getSimGid1", GetSimGid1),
        DECLARE_NAPI_WRITABLE_FUNCTION("getSimAccountInfo", GetSimAccountInfo),
        DECLARE_NAPI_WRITABLE_FUNCTION("isSimActive", IsSimActive),
        DECLARE_NAPI_WRITABLE_FUNCTION("isSimActiveSync", IsSimActiveSync),
        DECLARE_NAPI_WRITABLE_FUNCTION("activateSim", ActivateSim),
        DECLARE_NAPI_WRITABLE_FUNCTION("deactivateSim", DeactivateSim),
        DECLARE_NAPI_WRITABLE_FUNCTION("setShowName", SetShowName),
        DECLARE_NAPI_WRITABLE_FUNCTION("getShowName", GetShowName),
        DECLARE_NAPI_WRITABLE_FUNCTION("setShowNumber", SetShowNumber),
        DECLARE_NAPI_WRITABLE_FUNCTION("getShowNumber", GetShowNumber),
        DECLARE_NAPI_WRITABLE_FUNCTION("getOperatorConfigs", GetOperatorConfigs),
        DECLARE_NAPI_WRITABLE_FUNCTION("getActiveSimAccountInfoList", GetActiveSimAccountInfoList),
        DECLARE_NAPI_WRITABLE_FUNCTION("getSimTelephoneNumber", GetSimTelephoneNumber),
        DECLARE_NAPI_WRITABLE_FUNCTION("sendEnvelopeCmd", SendEnvelopeCmd),
        DECLARE_NAPI_WRITABLE_FUNCTION("sendTerminalResponseCmd", SendTerminalResponseCmd),
        DECLARE_NAPI_WRITABLE_FUNCTION("acceptCallSetupRequest", AcceptCallSetupRequest),
        DECLARE_NAPI_WRITABLE_FUNCTION("rejectCallSetupRequest", RejectCallSetupRequest),
        DECLARE_NAPI_WRITABLE_FUNCTION("getMaxSimCount", GetMaxSimCount),
        DECLARE_NAPI_WRITABLE_FUNCTION("hasOperatorPrivileges", HasOperatorPrivileges),
        DECLARE_NAPI_WRITABLE_FUNCTION("getOpKey", GetOpKey),
        DECLARE_NAPI_WRITABLE_FUNCTION("getOpKeySync", GetOpKeySync),
        DECLARE_NAPI_WRITABLE_FUNCTION("getOpName", GetOpName),
        DECLARE_NAPI_WRITABLE_FUNCTION("getOpNameSync", GetOpNameSync),
        DECLARE_NAPI_WRITABLE_FUNCTION("getDsdsMode", GetDsdsMode),
        DECLARE_NAPI_WRITABLE_FUNCTION("getSimAuthentication", GetSimAuthentication),
