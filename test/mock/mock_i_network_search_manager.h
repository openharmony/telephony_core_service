...
public:
    ...
    MOCK_METHOD(int32_t, SetRadioState, (int32_t slotId, bool isOn, int32_t rst, const sptr<INetworkSearchCallback> &callback), (override));
    MOCK_METHOD(int32_t, GetSignalInfoList, (int32_t slotId, std::vector<sptr<SignalInformation>> &signals), (override));
    MOCK_METHOD(void, RegisterCoreNotify, (int32_t slotId, const std::shared_ptr<AppExecFwk::EventHandler> &handler, int32_t what), (override));
    MOCK_METHOD(void, UnRegisterCoreNotify, (int32_t slotId, const std::shared_ptr<AppExecFwk::EventHandler> &handler, int32_t what), (override));
