...
public:
    ...
    MOCK_METHOD(int32_t, GetNetworkStatus, (int32_t slotId, sptr &networkState), (override));
    ...
    MOCK_METHOD(int32_t, SetRadioState, (int32_t slotId, bool isOn, int32_t rst, const sptr &callback), (override));
    MOCK_METHOD(int32_t, GetSignalInfoList, (int32_t slotId, std::vector<sptr> &signals), (override));
    MOCK_METHOD(void, RegisterCoreNotify, (int32_t slotId, const std::shared_ptrAppExecFwk::EventHandler &handler, int32_t what), (override));
    MOCK_METHOD(void, UnRegisterCoreNotify, (int32_t slotId, const std::shared_ptrAppExecFwk::EventHandler &handler, int32_t what), (override));
    MOCK_METHOD(void, RegisterCellularDataObject, (const sptr &callback), (override));
    MOCK_METHOD(void, UnRegisterCellularDataObject, (const sptr &callback), (override));
    MOCK_METHOD(void, RegisterCellularCallObject, (const sptr &callback), (override));
    MOCK_METHOD(void, UnRegisterCellularCallObject, (const sptr &callback), (override));
    ...
    MOCK_METHOD(sptr, GetCellLocation, (int32_t slotId), (override));
    ...
    MOCK_METHOD(int32_t, RegisterImsRegInfoCallback, (int32_t slotId, ImsServiceType imsSrvType, const int32_t tokenId, const sptr &callback), (override));
    MOCK_METHOD(int32_t, UnregisterImsRegInfoCallback, (int32_t slotId, ImsServiceType imsSrvType, const int32_t tokenId), (override));
    ...
    MOCK_METHOD(int32_t, GetNrSsbId, (int32_t slotId, const std::shared_ptr &nrSsbInformation), (override));
