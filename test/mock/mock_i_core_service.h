...
public:
    ...
    MOCK_METHOD(int32_t, GetSignalInfoList, (int32_t slotId, std::vector<sptr<SignalInformation>> &signals), (override));
    MOCK_METHOD(int32_t, GetNetworkState, (int32_t slotId, sptr<NetworkState> &networkState), (override));
    MOCK_METHOD(int32_t, SetRadioState, (int32_t slotId, bool isOn, const sptr<INetworkSearchCallback> &callback), (override));
    ...
    MOCK_METHOD(int32_t, SetNrOptionMode, (int32_t slotId, int32_t mode, const sptr<INetworkSearchCallback> &callback), (override));
    ...
    MOCK_METHOD(int32_t, UnlockPin, (int32_t slotId, const std::u16string &pin, const sptr<IRawParcelCallback> &callback), (override));
    MOCK_METHOD(int32_t, UnlockPuk, (int32_t slotId, const std::u16string &newPin, const std::u16string &puk, const sptr<IRawParcelCallback> &callback), (override));
    MOCK_METHOD(int32_t, AlterPin, (int32_t slotId, const std::u16string &newPin, const std::u16string &oldPin, const sptr<IRawParcelCallback> &callback), (override));
    MOCK_METHOD(int32_t, UnlockPin2, (int32_t slotId, const std::u16string &pin2, const sptr<IRawParcelCallback> &callback), (override));
    MOCK_METHOD(int32_t, UnlockPuk2, (int32_t slotId, const std::u16string &newPin2, const std::u16string &puk2, const sptr<IRawParcelCallback> &callback), (override));
    MOCK_METHOD(int32_t, AlterPin2, (int32_t slotId, const std::u16string &newPin2, const std::u16string &oldPin2, const sptr<IRawParcelCallback> &callback), (override));
    MOCK_METHOD(int32_t, SetLockState, (int32_t slotId, const LockInfo &options, const sptr<IRawParcelCallback> &callback), (override));
    ...
    MOCK_METHOD(int32_t, GetNetworkSearchInformation, (int32_t slotId, const sptr<INetworkSearchCallback> &callback), (override));
    MOCK_METHOD(int32_t, GetNetworkSelectionMode, (int32_t slotId, const sptr<INetworkSearchCallback> &callback), (override));
    ...
    MOCK_METHOD(int32_t, GetPreferredNetwork, (int32_t slotId, const sptr<INetworkSearchCallback> &callback), (override));
    MOCK_METHOD(int32_t, SetPreferredNetwork, (int32_t slotId, int32_t networkMode, const sptr<INetworkSearchCallback> &callback), (override));
    ...
    MOCK_METHOD(int32_t, RegisterImsRegInfoCallback, (int32_t slotId, ImsServiceType imsSrvType, const sptr<INetworkSearchCallback> &callback), (override));
