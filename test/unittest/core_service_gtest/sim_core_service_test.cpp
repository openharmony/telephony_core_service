...
HWTEST_F(SimTest, Telephony_Sim_CoreService_0100, Function | MediumTest | Level3)
{
    ...
    EXPECT_NE(mCoreService->UnlockPin2(0, testU16Str, callback0), TELEPHONY_ERR_SUCCESS);
    EXPECT_NE(mCoreService->UnlockPuk2(0, testU16Str, testU16Str, callback0), TELEPHONY_ERR_SUCCESS);
    ...
    EXPECT_NE(mCoreService->SetShowNumber(0, testU16Str, callback0), TELEPHONY_ERR_SUCCESS);
    EXPECT_NE(mCoreService->GetShowNumber(0, callback0), TELEPHONY_ERR_SUCCESS);
    EXPECT_NE(mCoreService->SetShowName(0, testU16Str, callback0), TELEPHONY_ERR_SUCCESS);
...
HWTEST_F(SimTest, Telephony_Sim_CoreService_0500, Function | MediumTest | Level3)
{
    ...
    std::vector<IccAccountInfo> iccAccountInfoList = {};
    EXPECT_NE(mCoreService->GetActiveSimAccountInfoList(iccAccountInfoList), TELEPHONY_ERR_SUCCESS);
    EXPECT_NE(mCoreService->GetAllSimAccountInfoList(iccAccountInfoList), TELEPHONY_ERR_SUCCESS);
...
HWTEST_F(SimTest, Telephony_Sim_InitTelephonyExtService_0100, Function | MediumTest | Level1)
{
    ...
    if (TELEPHONY_EXT_WRAPPER.telephonyExtWrapperHandle_ == nullptr) {
        ...
        EXPECT_EQ(TELEPHONY_EXT_WRAPPER.cacheAssetPinForUpgrade_ != nullptr, true);
    }
}
