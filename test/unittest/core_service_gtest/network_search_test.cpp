...
bool NetworkSearchTest::HasSimCard(int32_t slotId)
{
    ...
    NetworkSearchTest::telephonyService_->HasSimCard(slotId, hasSimCard);
    return hasSimCard;
}
...
HWTEST_F(NetworkSearchTest, Telephony_NetworkSearch_GetCsRadioTech_0300, Function | MediumTest | Level1)
{
    ...
    TELEPHONY_LOGI("TelephonyTestService GetCsRadioTech result: %{public}d", result);
    EXPECT_EQ(TELEPHONY_ERR_PERMISSION_ERR, result);
}
...
HWTEST_F(NetworkSearchTest, Telephony_NetworkSearch_SetNrOptionMode_0100, Function | MediumTest | Level3)
{
    ...
    sptr<NetworkSearchTestCallbackStub> callback(new NetworkSearchTestCallbackStub());
    int32_t result = CoreServiceClient::GetInstance().SetNrOptionMode(SLOT_ID, NR_NSA_OPTION_ONLY, callback);
...
HWTEST_F(NetworkSearchTest, Telephony_NetworkSearch_IsGsm__0100, Function | MediumTest | Level3)
{
    AccessToken token;
    bool isGsm = false;
    CoreManagerInner::GetInstance().IsGsm(SLOT_ID, false);
...
HWTEST_F(NetworkSearchTest, Telephony_NetworkSearch_IsCdma__0100, Function | MediumTest | Level3)
{
    AccessToken token;
    bool isCdma = false;
    CoreManagerInner::GetInstance().IsCdma(SLOT_ID, false);
