...
HWTEST_F(CoreServiceBranchTest, Telephony_CoreService_NetWork_002, Function | MediumTest | Level1)
{
    ...
    result = DelayedSingleton<CoreService>::GetInstance()->GetImei(SLOT_ID, callback0);
    DelayedSingleton<CoreService>::GetInstance()->GetImeiSv(SLOT_ID, callback0);
...
/**
 * @tc.number   Telephony_CoreService_NetWork_003
 * @tc.name     test normal branch
 * @tc.desc     Function test
 */
...
HWTEST_F(CoreServiceBranchTest, Telephony_CoreService_Sim_001, Function | MediumTest | Level1)
{
    ...
    EXPECT_GE(result, TELEPHONY_ERR_SUCCESS);
    DelayedSingleton<CoreService>::GetInstance()->IsSimActive(SLOT_ID, callback0);
    int32_t simId = 1;
    ...
    DelayedSingleton<CoreService>::GetInstance()->GetDefaultVoiceSimId(callback0);
    EXPECT_GE(result, TELEPHONY_ERR_SUCCESS);
    int32_t dsdsMode = 0;
    ...
    EXPECT_GE(result, TELEPHONY_ERR_SUCCESS);
    DelayedSingleton<CoreService>::GetInstance()->SetShowName(SLOT_ID, cardName, callback0);
...
HWTEST_F(CoreServiceBranchTest, Telephony_CoreService_Sim_002, Function | MediumTest | Level1)
{
    ...
    auto callback0 = sptr<MockRawParcelCallback>::MakeSptr();
    DelayedSingleton<CoreService>::GetInstance()->IsCTSimCard(SLOT_ID, callback0);
    EXPECT_GE(result, TELEPHONY_ERR_SUCCESS);
}
...
HWTEST_F(CoreServiceBranchTest, InsertEsimDatatest_001, Function | MediumTest | Level1)
{
    std::shared_ptr<TelRilManager> telRilManager = std::make_shared<TelRilManager>();
    std::vector<std::shared_ptr<Telephony::SimStateManager>> simStateManager = { nullptr, nullptr };
    std::vector<std::shared_ptr<Telephony::SimFileManager>> simFileManager = { nullptr, nullptr };
...
HWTEST_F(CoreServiceBranchTest, InsertEsimDatatest_002, Function | MediumTest | Level1)
{
    std::shared_ptr<TelRilManager> telRilManager = std::make_shared<TelRilManager>();
    std::vector<std::shared_ptr<Telephony::SimStateManager>> simStateManager = { nullptr, nullptr };
    std::vector<std::shared_ptr<Telephony::SimFileManager>> simFileManager = { nullptr, nullptr };
...
HWTEST_F(CoreServiceBranchTest, InsertEsimDatatest_003, Function | MediumTest | Level1)
{
    std::shared_ptr<TelRilManager> telRilManager = std::make_shared<TelRilManager>();
    std::vector<std::shared_ptr<Telephony::SimStateManager>> simStateManager = { nullptr, nullptr };
    std::vector<std::shared_ptr<Telephony::SimFileManager>> simFileManager = { nullptr, nullptr };
...
HWTEST_F(CoreServiceBranchTest, InsertEsimDatatest_004, Function | MediumTest | Level1)
{
    std::shared_ptr<TelRilManager> telRilManager = std::make_shared<TelRilManager>();
    std::vector<std::shared_ptr<Telephony::SimStateManager>> simStateManager = { nullptr, nullptr };
    std::vector<std::shared_ptr<Telephony::SimFileManager>> simFileManager = { nullptr, nullptr };
...
HWTEST_F(CoreServiceBranchTest, InsertEsimDatatest_005, Function | MediumTest | Level1)
{
    std::shared_ptr<TelRilManager> telRilManager = std::make_shared<TelRilManager>();
    std::vector<std::shared_ptr<Telephony::SimStateManager>> simStateManager = { nullptr, nullptr };
    std::vector<std::shared_ptr<Telephony::SimFileManager>> simFileManager = { nullptr, nullptr };
...
HWTEST_F(CoreServiceBranchTest, GetSimIdtest_002, Function | MediumTest | Level1)
{
    std::shared_ptr<TelRilManager> telRilManager = std::make_shared<TelRilManager>();
    std::vector<std::shared_ptr<Telephony::SimStateManager>> simStateManager = { nullptr, nullptr };
    std::vector<std::shared_ptr<Telephony::SimFileManager>> simFileManager = { nullptr, nullptr };
...
HWTEST_F(CoreServiceBranchTest, GetSimIdtest_003, Function | MediumTest | Level1)
{
    std::shared_ptr<TelRilManager> telRilManager = std::make_shared<TelRilManager>();
    std::vector<std::shared_ptr<Telephony::SimStateManager>> simStateManager = { nullptr, nullptr };
    std::vector<std::shared_ptr<Telephony::SimFileManager>> simFileManager = { nullptr, nullptr };
