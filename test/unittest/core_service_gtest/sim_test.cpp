...
HWTEST_F(SimTest, Telephony_Sim_TestDump_0100, Function | MediumTest | Level3)
{
    ...
    EXPECT_GE(DelayedSingleton<CoreService>::GetInstance()->Dump(-1, args), 0);
    EXPECT_GE(DelayedSingleton<CoreService>::GetInstance()->Dump(0, emptyArgs), 0);
    EXPECT_GE(DelayedSingleton<CoreService>::GetInstance()->Dump(0, args), 0);
}
