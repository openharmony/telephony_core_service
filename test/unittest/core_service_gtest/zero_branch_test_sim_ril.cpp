...
HWTEST_F(SimRilBranchTest, Telephony_IccDiallingNumbersCache_004, Function | MediumTest | Level1)
{
    ...
    auto result = diallingNumbersCache->IsDiallingNumberEqual(diallingNumber, diallingNumber);
    EXPECT_TRUE(result);
}
...
HWTEST_F(SimRilBranchTest, Telephony_IccDiallingNumbersCache_005, Function | MediumTest | Level1)
{
    ...
    auto result = diallingNumbersCache->ArrayEqual(args1, args2);
    EXPECT_FALSE(result);
}
...
HWTEST_F(SimRilBranchTest, Telephony_UsimDiallingNumbersService_001, Function | MediumTest | Level1)
{
    ...
    auto pointer = usimDiallingNumbersService->CreateHandlerPointer(-1, 1, 0, nullptr);
    EXPECT_NE(pointer, nullptr);
    auto fileByRecord = usimDiallingNumbersService->BuildNumberFileByRecord(record);
    EXPECT_NE(fileByRecord, nullptr);
...
HWTEST_F(SimRilBranchTest, Telephony_UsimDiallingNumbersService_003, Function | MediumTest | Level1)
{
    ...
    EXPECT_EQ(usimDiallingNumbersService->pbrIndex_, 0);
}
...
HWTEST_F(SimRilBranchTest, Telephony_UsimDiallingNumbersService_005, Function | MediumTest | Level1)
{
    ...
    records.push_back(record);
    usimDiallingNumbersService->GeneratePbrFile(records);
    auto result = usimDiallingNumbersService->LoadDiallingNumberFiles(0);
    EXPECT_FALSE(result);
}
...
HWTEST_F(SimRilBranchTest, Telephony_SimStateManager_002, Function | MediumTest | Level1)
{
    ...
    EXPECT_NE(simStateManager->NotifySimSlotsMapping(0), TELEPHONY_ERR_SUCCESS);
    EXPECT_NE(simStateManager->SetIccCardState(0, 0), TELEPHONY_ERR_SUCCESS);
}
...
HWTEST_F(SimRilBranchTest, Telephony_tel_ril_manager_001, Function | MediumTest | Level1)
{
    ...
    EXPECT_EQ(sms, nullptr);
    auto sim = telRilManager->GetTelRilSim(slotFaild);
    EXPECT_EQ(sim, nullptr);
    auto modem = telRilManager->GetTelRilModem(slotFaild);
    EXPECT_EQ(modem, nullptr);
    auto data = telRilManager->GetTelRilData(slotFaild);
    EXPECT_EQ(data, nullptr);
    auto network = telRilManager->GetTelRilNetwork(slotFaild);
    EXPECT_EQ(network, nullptr);
    auto call = telRilManager->GetTelRilCall(slotFaild);
...
HWTEST_F(SimRilBranchTest, Telephony_IccFileController_Expand001, Function | MediumTest | Level1)
{
    ...
    rcvMsg->fileData.resultData = "BF70820686A08206823082067ea0820635048206313c2a12361636c856472212e939eb2fe56715cacf";
    ...
    std::unique_ptr<Telephony::IccFromRilMsg> rcvMsgHolderNullptr = std::make_unique<Telephony::IccFromRilMsg>(holderNullptr);
    rcvMsgHolderNullptr->fileData.sw1 = 0x90;
    rcvMsgHolderNullptr->fileData.sw2 = 0x00;
    rcvMsgHolderNullptr->fileData.resultData = "BF70820686A08206823082067ea0820635048206313c2a12361636c856472212e939eb2fe56715cacf";
    auto event8 = AppExecFwk::InnerEvent::Get(0, rcvMsgHolderNullptr);
    ...
    iccFileController->ProcessRecordSize(event8);
    rcvMsg->fileData.resultData = "";
    iccFileController->ProcessRecordSize(event7);
    rcvMsg->fileData.resultData = "BF70840686A08206823082067ea0820635048206313c2a12361636c856472212e939eb2fe56715cacf";
    iccFileController->ProcessRecordSize(event7);

    iccFileController->ProcessInvalidRecord(event);
    iccFileController->ProcessInvalidRecord(event8);
    holder->fileNum = 1;
    holder->countFiles = 0;
    iccFileController->ProcessRecordSize(event7);
    holder->fileNum = 1;
    ...
    iccFileController->ProcessReadRecord(event8);
    holder->getAllFile = true;
    holder->fileNum = 1;
    holder->countFiles = 0;
    iccFileController->ProcessReadRecord(event7);
    holder->fileNum = 1;
    holder->countFiles = 9999;
    iccFileController->ProcessReadRecord(event7);
    ...
    iccFileController->ProcessReadBinary(event7);
    ...
    holder->fileLoaded->SetOwner(nullptr);
    iccFileController->ProcessErrorResponse(event7);
    holder->fileLoaded = nullptr;
    iccFileController->ProcessErrorResponse(event7);

    EXPECT_FALSE( iccFileController->IsValidBinarySizeData(nullptr) );
}
...
HWTEST_F(SimRilBranchTest, Telephony_IccDiallingNumbersManager_002, Function | MediumTest | Level1)
{
    ...
    EXPECT_EQ(iccDiallingNumbersManager.DelIccDiallingNumbers(0, diallingNumbers), TELEPHONY_ERR_LOCAL_PTR_NULL);
...
/**
 * @tc.number   Telephony_IccDiallingNumbersCache_007
 * @tc.name     test error branch
 * @tc.desc     Function test
 */
HWTEST_F(SimRilBranchTest, Telephony_IccDiallingNumbersCache_007, Function | MediumTest | Level1)
{
    std::shared_ptr<TelRilManager> telRilManager = std::make_shared<TelRilManager>();
    std::shared_ptr<Telephony::SimStateManager> simStateManager = std::make_shared<SimStateManager>(telRilManager);
    auto simFileManager = std::make_shared<SimFileManager>(telRilManager, simStateManager);
    ...
    std::vector<std::shared_ptr<DiallingNumbersInfo>> result = {};
    iccDiallingNumbersManager->diallingNumbersCache_ = std::make_shared<IccDiallingNumbersCache>(simFileManager);
    EXPECT_EQ(iccDiallingNumbersManager->QueryIccDiallingNumbers(2, result), TELEPHONY_ERR_NO_SIM_CARD);
    simStateManager->Init(0);
    simStateManager->simStateHandle_->iccState_.simStatus_ = ICC_CONTENT_READY;
    iccDiallingNumbersManager->hasQueryEventDone_ = true;
...
/**
 * @tc.number   Telephony_IccDiallingNumbersCache_008
 * @tc.name     test error branch
 * @tc.desc     Function test
 */
HWTEST_F(SimRilBranchTest, Telephony_IccDiallingNumbersCache_008, Function | MediumTest | Level1)
{
    std::shared_ptr<TelRilManager> telRilManager = std::make_shared<TelRilManager>();
    std::shared_ptr<Telephony::SimStateManager> simStateManager = std::make_shared<SimStateManager>(telRilManager);
    auto simFileManager = std::make_shared<SimFileManager>(telRilManager, simStateManager);
    ...
    simStateManager->Init(0);
    simStateManager->simStateHandle_->iccState_.simStatus_ = ICC_CONTENT_READY;
    EXPECT_TRUE(iccDiallingNumbersManager->HasSimCard());
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(SimRilBranchTest, Telephony_SimFileManager_002, Function | MediumTest | Level1)
{
    std::shared_ptr<TelRilManager> telRilManager = std::make_shared<TelRilManager>();
    std::shared_ptr<Telephony::SimStateManager> simStateManager = std::make_shared<SimStateManager>(telRilManager);
    auto simFileManager = std::make_shared<SimFileManager>(telRilManager, simStateManager);
    ...
    simFileManager->GetIccFile();
    simFileManager->SetImsi("12345");
    ...
    EXPECT_FALSE(simFileManager->SetVoiceCallForwarding(true, "1234"));
    EXPECT_EQ(simFileManager->ObtainSpnCondition(true, "1234"), 0);
    simFileManager->SetImsi("12345");
    simFileManager->UpdateOpkeyConfig();
    simFileManager->HandleOperatorConfigChanged();
    simFileManager->HandleSimRecordsLoaded();
    simFileManager->HandleSimIccidLoaded("");
    EXPECT_FALSE(simFileManager->SetVoiceMailInfo(u"", u""));
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(SimRilBranchTest, Telephony_SimFileManager_003, Function | MediumTest | Level1)
{
    std::shared_ptr<TelRilManager> telRilManager = std::make_shared<TelRilManager>();
    std::shared_ptr<Telephony::SimStateManager> simStateManager = std::make_shared<SimStateManager>(telRilManager);
    auto simFileManager = std::make_shared<SimFileManager>(telRilManager, simStateManager);
...
/**
 * @tc.number   Telephony_SimFileManager_004
 * @tc.name     test error branch
 * @tc.desc     Function test
 */
HWTEST_F(SimRilBranchTest, Telephony_SimFileManager_004, Function | MediumTest | Level1)
{
    std::shared_ptr<TelRilManager> telRilManager = std::make_shared<TelRilManager>();
    std::shared_ptr<Telephony::SimStateManager> simStateManager = std::make_shared<SimStateManager>(telRilManager);
    auto simFileManager = std::make_shared<SimFileManager>(telRilManager, simStateManager);
...
/**
 * @tc.number   Telephony_SimFileManager_005
 * @tc.name     test error branch
 * @tc.desc     Function test
 */
HWTEST_F(SimRilBranchTest, Telephony_SimFileManager_005, Function | MediumTest | Level1)
{
    std::shared_ptr<TelRilManager> telRilManager = std::make_shared<TelRilManager>();
    std::shared_ptr<Telephony::SimStateManager> simStateManager = std::make_shared<SimStateManager>(telRilManager);
    auto simFileManager = std::make_shared<SimFileManager>(telRilManager, simStateManager);
