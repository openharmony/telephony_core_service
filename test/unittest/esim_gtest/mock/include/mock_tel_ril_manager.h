...
public:
    ...
    MOCK_METHOD3(EnableEmcRescue, int32_t(int32_t, int32_t, const AppExecFwk::InnerEvent::Pointer &));
    MOCK_METHOD3(EnableEmcRescueNetworkSearch, int32_t(
        int32_t, int32_t, const AppExecFwk::InnerEvent::Pointer &));
    MOCK_METHOD4(StartEmcRescueService, int32_t(int32_t, int64_t, int32_t,
        const AppExecFwk::InnerEvent::Pointer &));
    MOCK_METHOD4(ConfigEmcRescueRsrpReport, int32_t(int32_t, int32_t, int32_t,
        const AppExecFwk::InnerEvent::Pointer &));
    MOCK_METHOD4(SendEmcRescueMessage, int32_t(int32_t, int32_t, std::string &,
        const AppExecFwk::InnerEvent::Pointer &));
};
} // namespace Telephony
} // namespace OHOS
