...
static const std::string BOUND_PROFILE_PACKAGE_GET_BPP_LOAD_ERROR_A300 = "vzaCAAKjAA==";

static const std::string BOUND_PROFILE_PACKAGE_GET_BPP_LOAD_ERROR_NULLPTR =
    "YmYzNjgyMDNkYmJmMjM4MWIwODIwMTAxODAxMDRmNzQ0NjIxMWYzMzY5NDA4NWJhYTBmMGJjM2EzYjIzYTYxMjgwMDE4ODgxMDE"
    "xMDg0MGE0NzUzNGQ0MTIwNTM0ZDJkNTg1ODVmNDk0MTA0MDdkOGJjZmNhNWFhZmViYzUwOWRlMmRmMGQwMGQyMzhmYTA2MmY0Zj"
    "c0NDQ1MjMwYzY1YTU5NzY0MTQ0OTMwYzM1MzFkOWU2Nzc3OTUxZWY2Y2I3N2NkMDYyZDI0MWZkOWQzYTAwYTllNzdhNWQyNzRmO"
    "WNiYmVlMTE0OWYzZmI1ZjM3NDA2OTJjNzI4YjFjMjliMTM3MzFiMzc2M2NlMThlNmQ1MDc5ZmQ5YTZiZTc2YThjMjFmZmNmZGFh"
    "YzBkOTIzN2EyNmE4N2Y5ZDRiZDM0ZGMwMmM5ZTM1N2M5NTcxZTA4NWM0MDQ0ZmJlMWU1NjYwZTUzMzJhNDk1Y2RiODI0NDNlM2E"
    "wMWE4NzE4ZjVjODZlMzk4ODZlNGYzOWNkYTE1ODc0ZWUyODdhMDQ0MmU3OTlkNDc3OTIwZDgyYTE4MjAzMDU4ODgyMDMwMWJmMj"
    "U4MjAyZjQ1YTBhOTg5MjA5MDEyMTQzNjU4NzA5ZjU5MTA5NTM1MDIwNGU2MTZkNjUyMDMxOTIxYTRmNzA2NTcyNjE3NDY5NmY2Z"
    "TYxNmMyMDUwNzI2ZjY2Njk2YzY1MjA0ZTYxNmQ2NTIwMzE5MzAxMDE5NDgyMDI5MDg5NTA0ZTQ3MGQwYTFhMGEwMDAwMDAwZDQ5"
    "NDg0NDUyMDAwMDAwNDAwMDAwMDA0MDA4MDQwMDAwMDAwMDYwYjk1NTAwMDAwMDA3NzQ0OTRkNDUwN2UwMGIwOTEwMDczNjRjOTU"
    "2Zjk3MDAwMDAwMDk3MDQ4NTk3MzAwMDAwYjEyMDAwMDBiMTIwMWQyZGQ3ZWZjMDAwMDAwMDQ2NzQxNGQ0MTAwMDBiMThmMGJmYz"
    "YxMDUwMDAwMDIxZjQ5NDQ0MTU0NzhkYWVkOTljZDE1ODMyMDBjODAzZDMyMDAwYjMwMDRhYmIwMGVjYmIwODIyMzM4NTc4YWY1N"
    "TkyMjNmNDliMGE4MTc1ZjJlYzAyM2UxMjM4NDEwZGIwOWE2NjdlNWUxZTU1ZjgwYmYwMGY2ODYwNjBiMWU2NmI4MDQyMGMwMmEz"
    "MjU1MGQwZTk2NmU4Y2M2ZjAxMjhkMTkzNDYwNjM1ZmE2NmEzYjdkNTExZGI0OGRkOTQ3ODhiNjU1ZDc4MTUwNzFiYTI2ZTYxYjk"
    "wMDBhY2M3MTE4NDEwODVlYjM5OGQ4NGMwY2Q5NGY5MjFlYmUyZGRhYjE4ZGI2YjUwMDViMDU1YzNiYzc1MmI0MDM4NzQ1YzUzMz"
    "k0NDljZDQ5NTAyNDgxMDBlMWQ0NTI4ZmFjMjA3YjIyOGUzMTAxYTRiZDRhZTUyYmE5NmE2MDM4MDhiMDVkNDRjMjdhZGFiMmFmO"
    "DgwN2EwMGE2MTg0YjIyODAxNDgwNzU2NmVjYTEzNTM4ZTUwMDhhYzg5MGJmMDZiZTgwOWU0ZGJlYmUwYjgwOGE4NDJhMDA5ZmZk"
    "N2IwMTA0MzZhZjA2YjA0ZjAzNGM4ZDQ3ZWE0NjAwNDcwM2UwMzRlNGQ5NWI5MGE5OGE0NDczMDBkYzM1M2M5ZjA3YTg0MzQwNGQ"
    "5YjJkOTA0YmNhODRmNjI0ODBhNzAxM2MzOTM1MTQzMTIyNWI3MjJkZTlmNmFkNTkxYTAwNDdjMTk0ZTVhZTE5YmQ4NjVhZmMxYT"
    "I2OTc2ZjA4ODYwM2MwYTdhYzkxMTdmY2UxMzFmNjQyMDBiY2RmZWQ4ZTI5MGVlMDU4OTA2YzQ2ZjJmYWQwOWRhYzg4NWFiMTU1M"
    "GM2OGQyYThiNDI2ZGNmNjliOGU3MWY3NmQxOTViMTVjZDM2ODIwNzQ2MzUxM2ZkMmRlYTY2NDg0NzZiMjUwMGViOTk5YjYyNTBm"
    "YTVkYzA0OTllMGI4OGI5MjFmMmJiYWY3ODJlODc3NTg4OTMwMzcwNzI0ZTRkM2YwZGQwMWQ0OWRiZTdlOTJjYjk0MDQyMzE3MjA"
    "wOGYzZWQzYzYwMTFjMDNiMTM5NmJjZTZlYzI0ODAwYzcwM2I4NjI2ODI0ODBhMjAxNDIyNTBiOGMwNWMwODEzODUxODZjZDY1MD"
    "A5NjA3ZDA1OWRkNzcyYjgwYWUzY2I5NjMwMTAyMDViMDU0NDM2NDE0ODA4YWJiMGZmMjM3NzUyNDgwYTk5NmZiMzcwMmQ4MzM0Z"
    "mRhMGJmMDAyYmMwMDJmYzA0ODgwNTNiNWY1MzgwMDA1ZGMwYTE3MDNmMDNmZmRmZGM0MzNhNmZhMDEwY2YxZWY0MTY1YzgzMWU2"
    "MDJiNDAxMzQ4NDRjNjZlNjdmYTRjMTAwMDYxOGU1YWI4ZjYwMDhjMDNmYWFiNzAyOGM5MTE3ZTAwMzZiYWY0NDkxNzAzNWFmMGU"
...
HWTEST_F(EsimTest, ProcessObtainEidDone_001, Function | MediumTest | Level2)
{
    ...
    EXPECT_FALSE(esimFile->ProcessObtainEidDone(event));
...
HWTEST_F(EsimTest, ProcessRequestAllProfilesDone_001, Function | MediumTest | Level2)
{
    ...
    auto event = AppExecFwk::InnerEvent::Get(0, rcvMsg);
    EXPECT_FALSE(esimFile->ProcessRequestAllProfilesDone(event));
...
HWTEST_F(EsimTest, ProcessRequestRulesAuthTableDone_001, Function | MediumTest | Level2)
{
    ...
    rcvMsg->fileData.resultData = "BF434B"
        ...
        "9000";
    auto event = AppExecFwk::InnerEvent::Get(0, rcvMsg);
    EXPECT_FALSE(esimFile->ProcessRequestRulesAuthTableDone(event));
    auto event1 = AppExecFwk::InnerEvent::Get(0);
    EXPECT_EQ(esimFile->ProcessRequestRulesAuthTableDone(event1), false);
    event1 = nullptr;
    EXPECT_EQ(esimFile->ProcessRequestRulesAuthTableDone(event1), false);
}
...
HWTEST_F(EsimTest, ProcessObtainEuiccChallengeDone_001, Function | MediumTest | Level2)
{
    ...
    auto event = AppExecFwk::InnerEvent::Get(0, rcvMsg);
    EXPECT_FALSE(esimFile->ProcessObtainEuiccChallengeDone(event));
...
HWTEST_F(EsimTest, ProcessObtainDefaultSmdpAddressDone_001, Function | MediumTest | Level2)
{
    ...
    auto event = AppExecFwk::InnerEvent::Get(0, rcvMsg);
    EXPECT_FALSE(esimFile->ProcessObtainDefaultSmdpAddressDone(event));
    auto event1 = AppExecFwk::InnerEvent::Get(0);
...
HWTEST_F(EsimTest, ProcessResetMemoryDone_001, Function | MediumTest | Level2)
{
    ...
    auto event = AppExecFwk::InnerEvent::Get(0, rcvMsg);
    EXPECT_FALSE(esimFile->ProcessResetMemoryDone(event));
...
HWTEST_F(EsimTest, BuildApduForInitSecureChannel_001, Function | MediumTest | Level2)
{
    ...
    std::vector<uint8_t> src;
    bppNode = std::make_shared<Asn1Node>(0, src, 0, 0);
    std::shared_ptr<Asn1Node> initSecureChannelReq = std::make_shared<Asn1Node>(0, src, 0, 0);
...
HWTEST_F(EsimTest, BuildApduForFirstSequenceOf87_001, Function | MediumTest | Level2)
{
    ...
    std::vector<uint8_t> src;
    bppNode = std::make_shared<Asn1Node>(0, src, 0, 0);
    std::shared_ptr<Asn1Node> firstSequenceOf87 = std::make_shared<Asn1Node>(0, src, 0, 0);
...
HWTEST_F(EsimTest, BuildApduForSequenceOf88_001, Function | MediumTest | Level2)
{
    ...
    RequestApduBuild codec(currentChannelId_);
    std::vector<uint8_t> src;
    std::shared_ptr<Asn1Node> sequenceOf88 = std::make_shared<Asn1Node>(0, src, 0, 0);
...
HWTEST_F(EsimTest, BuildApduForSequenceOf86_001, Function | MediumTest | Level2)
{
    ...
    std::vector<uint8_t> src;
    bppNode = std::make_shared<Asn1Node>(0, src, 0, 0);
    std::shared_ptr<Asn1Node> sequenceOf86 = std::make_shared<Asn1Node>(0, src, 0, 0);
...
HWTEST_F(EsimTest, ProcessLoadBoundProfilePackage_002, Function | MediumTest | Level2)
{
    ...
    EXPECT_FALSE(esimFile->ProcessLoadBoundProfilePackage(slotId));
    esimFile->currentChannelId_ = 1;
    esimFile->esimProfile_.boundProfilePackage = Str8ToStr16(BOUND_PROFILE_PACKAGE_GET_BPP_LOAD_ERROR_A300);
    EXPECT_FALSE(esimFile->ProcessLoadBoundProfilePackage(slotId));
    esimFile->currentChannelId_ = 2;
    esimFile->esimProfile_.boundProfilePackage = Str8ToStr16(BOUND_PROFILE_PACKAGE_GET_BPP_LOAD_ERROR_NULLPTR);
    EXPECT_FALSE(esimFile->ProcessLoadBoundProfilePackage(slotId));
...
HWTEST_F(EsimTest, ProcessLoadBoundProfilePackageDone_001, Function | MediumTest | Level2)
{
    ...
    auto event = AppExecFwk::InnerEvent::Get(0, rcvMsg);
    EXPECT_FALSE(esimFile->ProcessLoadBoundProfilePackageDone(event));
    auto event1 = AppExecFwk::InnerEvent::Get(0);
...
HWTEST_F(EsimTest, LoadBoundProfilePackageParseNotificationMetadata_001, Function | MediumTest | Level2)
{
    ...
    EXPECT_FALSE(esimFile->LoadBoundProfilePackageParseNotificationMetadata(nodeNotificationMetadata));
}
...
HWTEST_F(EsimTest, ProcessListNotificationsAsn1Response_001, Function | MediumTest | Level2)
{
    ...
    EXPECT_NE(esimFile->ProcessListNotificationsAsn1Response(profileNode), true);
    uint32_t byteLen = responseByte.size();
}
...
HWTEST_F(EsimTest, ProcessRemoveNotificationDone_001, Function | MediumTest | Level2)
{
    ...
    auto event = AppExecFwk::InnerEvent::Get(0, rcvMsg);
    EXPECT_FALSE(esimFile->ProcessRemoveNotificationDone(event));
...
HWTEST_F(EsimTest, ProcessRetrieveNotificationListDone_001, Function | MediumTest | Level2)
{
    ...
    auto event = AppExecFwk::InnerEvent::Get(0, rcvMsg);
    EXPECT_FALSE(esimFile->ProcessRetrieveNotificationListDone(event));
    auto event1 = AppExecFwk::InnerEvent::Get(0);
...
HWTEST_F(EsimTest, ProcessDeleteProfileDone_001, Function | MediumTest | Level2)
{
    ...
    auto event = AppExecFwk::InnerEvent::Get(0, rcvMsg);
    EXPECT_FALSE(esimFile->ProcessDeleteProfileDone(event));
...
HWTEST_F(EsimTest, ProcessSwitchToProfileDone_001, Function | MediumTest | Level2)
{
    ...
    auto event = AppExecFwk::InnerEvent::Get(0, rcvMsg);
    EXPECT_FALSE(esimFile->ProcessSwitchToProfileDone(event));
...
HWTEST_F(EsimTest, ProcessSetNicknameDone_001, Function | MediumTest | Level2)
{
    ...
    auto event = AppExecFwk::InnerEvent::Get(0, rcvMsg);
    EXPECT_FALSE(esimFile->ProcessSetNicknameDone(event));
...
HWTEST_F(EsimTest, ProcessAuthenticateServerDone_001, Function | MediumTest | Level2)
{
    ...
    auto event = AppExecFwk::InnerEvent::Get(0, rcvMsg);
    EXPECT_FALSE(esimFile->ProcessAuthenticateServerDone(event));
    auto event1 = AppExecFwk::InnerEvent::Get(0);
...
HWTEST_F(EsimTest, GetContractInfo_001, Function | MediumTest | Level2)
{
    ...
    getContractInfoRequest.mapMetaData.imei = u"123456787654321";
    getContractInfoRequest.mapMetaData.imei2 = u"723456787654327";
    getContractInfoRequest.mapMetaData.timestamp = u"2025-07-09T09:47:18+08:00";
    getContractInfoRequest.ePkPosHpke =
        u"04193c786771e820ab133de09c1ee6c8215fadab2bd2541c436d6b042c03c70a9a0fd9bcd50781da090a2c68fc1aaa7b1ed184d36927"
        "0f1fdc1da3261c38af1496";
