...
private:
    ...
    private:
        std::atomic_uint64_t totalHandledEvents_ { 0 };
        std::atomic_uint64_t currentQueueEvents_ { 0 };
        std::atomic_uint64_t submitedToFFRTEvents_ { 0 };
        std::atomic_uint64_t executedEvents_ { 0 };
        std::atomic_uint64_t removedEvents_ { 0 };
