...
class NetworkSearchManager : public testing::NiceMock, public std::enable_shared_from_this {
public:
    virtual ~NetworkSearchManager() = default;
    NetworkSearchManager(std::shared_ptr telRilManager, std::shared_ptr simManager)
    {
