...
public:
    ...
    virtual void OnSetRadioStatusCallback(const bool setResult, const int32_t errorCode);
    virtual void OnGetRadioStatusCallback(const bool setResult, const int32_t errorCode);
    virtual void OnGetNetworkSearchResult(
