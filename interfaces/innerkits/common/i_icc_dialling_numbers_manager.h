...
#ifndef OHOS_I_ICC_DIALLING_NUMBERS_MANAGER_H
#define OHOS_I_ICC_DIALLING_NUMBERS_MANAGER_H
#include "dialling_numbers_info.h"

namespace OHOS {
namespace Telephony {
class IIccDiallingNumbersManager {
public:
    virtual void Init() {}
...
#endif // OHOS_I_ICC_DIALLING_NUMBERS_MANAGER_H
