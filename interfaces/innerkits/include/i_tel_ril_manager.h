...
public:
    ...
    virtual int32_t GetImsRegStatus(int32_t slotId, const AppExecFwk::InnerEvent::Pointer &response) = 0;
    ...
    virtual int32_t GetSimPinInputTimes(int32_t slotId, const AppExecFwk::InnerEvent::Pointer &result) = 0;
    ...
    virtual int32_t GetSimPin2InputTimes(int32_t slotId, const AppExecFwk::InnerEvent::Pointer &result) = 0;
    ...
    virtual int32_t GetImsCallList(int32_t slotId, const AppExecFwk::InnerEvent::Pointer &response) = 0;
    ...
    virtual int32_t SetLteImsSwitchStatus(
        int32_t slotId, const int32_t active, const AppExecFwk::InnerEvent::Pointer &response) = 0;
