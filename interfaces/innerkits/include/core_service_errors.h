...
enum CoreServiceNetworkSearchErrorCode {
    CORE_SERVICE_EMPTY_IMEI = CORE_SERVICE_NETWORK_SEARCH_ERR_OFFSET,
    CORE_SERVICE_EMPTY_MEID,
    CORE_SERVICE_INTERVAL_TIME_TOO_SHORT,
    CORE_SERVICE_SEND_CALLBACK_FAILED,
