...
namespace Telephony {
/**
 * @brief Esim Result code.
 */
enum class EsimResultCode {
    ...
    RESULT_INVALID_BPP = 285,
    RESULT_DOWNLOAD_TIMEOUT = 287,
    RESULT_SECURE_ESIM_CN_SCAN_OVERSEA_PROFILE = 301,
    RESULT_SECURE_ESIM_OVERSEA_SCAN_CN_PROFILE = 302,
    RESULT_SECURE_ESIM_COUNTRY_SOURCE_TYPE_IS_LOCAL = 303,
    RESULT_NEED_CHECK_LOCATION_IN_CHINA = 304,
    RESULT_NEED_CHECK_LOCATION_IN_OVERSEA = 305,
    RESULT_CONFIRMATION_CODE_INCORRECT_IN_CN = 306,
    RESULT_CONFIRMATION_CODE_INCORRECT_IN_OVERSEA = 307,
...
enum class CancelReason {
    ...
    CANCEL_REASON_METADATA_MISMATCH = 4,
    CANCEL_REASON_LOAD_BPP_EXECUTION_ERROR = 5,
    CANCEL_REASON_UNDEFINED_REASON = 127,
};
