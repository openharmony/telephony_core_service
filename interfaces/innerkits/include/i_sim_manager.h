...
public:
    ...
    virtual int32_t SetPrimarySlotId(int32_t slotId, bool isUserSet = false) = 0;
    ...
    virtual int32_t ClearSimLabel(SimType simType) = 0;
    ...
    virtual void SendSimAccountLoadedInfo(int32_t slotId, int32_t event) = 0;
};
} // namespace Telephony
} // namespace OHOS
