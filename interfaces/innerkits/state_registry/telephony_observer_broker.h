...
public:
    ...
    virtual void OnCellularDataConnectStateUpdated(int32_t dataState, int32_t networkType) = 0;
    ...
    virtual void OnCellInfoUpdated(const std::vector<sptr<CellInformation>> &vec) = 0;
    virtual void OnSimStateUpdated(SimState state,  LockReason reason) = 0;
