...
public:
     ...
     * @return int32_t TELEPHONY_SUCCESS on success, others on failure.
     */
    virtual int32_t UpdateSimState(int32_t simId, SimState state, LockReason reason) = 0;
    ...
    /**
      ...
      */
    virtual int32_t UpdateCellInfo(int32_t simId, const std::vector<sptr<CellInformation>> &vec) = 0;
