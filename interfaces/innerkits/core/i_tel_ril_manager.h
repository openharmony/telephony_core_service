...
namespace OHOS {
namespace Telephony {
enum class ModemPowerState { CORE_SERVICE_POWER_OFF, CORE_SERVICE_POWER_ON, CORE_SERVICE_POWER_NOT_AVAILABLE };
...
public:
    ...
    virtual void RegisterCoreNotify(
        const std::shared_ptr<AppExecFwk::EventHandler> &handler, int what, uint8_t*) = 0;
    ...
    virtual void SetCallTransferInfo(
    ...
    virtual void GetPdpContextList(const AppExecFwk::InnerEvent::Pointer &response) = 0;
    /* PDP end */
    ...
    virtual void SendGsmSms(std::string smscPdu, std::string pdu, const AppExecFwk::InnerEvent::Pointer &response) = 0;

    virtual void SendCdmaSms(CdmaSmsMessageInfo &msg, const AppExecFwk::InnerEvent::Pointer &response) = 0;
    ...
    virtual void UnlockPuk2(
        std::string puk2, std::string pin2, const AppExecFwk::InnerEvent::Pointer &result) = 0;
