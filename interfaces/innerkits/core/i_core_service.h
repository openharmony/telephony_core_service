...
public:
    ...
    virtual bool UnlockPin(const int32_t slotId, std::u16string pin, LockStatusResponse &response) = 0;
    virtual bool UnlockPuk(
        const int32_t slotId, std::u16string newPin, std::u16string puk, LockStatusResponse &response) = 0;
    virtual bool AlterPin(
        const int32_t slotId, std::u16string newPin, std::u16string oldPin, LockStatusResponse &response) = 0;
    virtual bool UnlockPin2(const int32_t slotId, std::u16string pin2, LockStatusResponse &response) = 0;
    virtual bool UnlockPuk2(
        const int32_t slotId, std::u16string newPin2, std::u16string puk2, LockStatusResponse &response) = 0;
    virtual bool AlterPin2(
        const int32_t slotId, std::u16string newPin2, std::u16string oldPin2, LockStatusResponse &response) = 0;
    virtual bool SetLockState(
        const int32_t slotId, std::u16string pin, int32_t enable, LockStatusResponse &response) = 0;
    ...
    virtual bool SetActiveSim(const int32_t slotId, int32_t enable) = 0;
