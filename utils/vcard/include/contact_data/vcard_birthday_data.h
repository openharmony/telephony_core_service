...
#ifndef OHOS_VCARD_BIRTHDAY_DATA_H
#define OHOS_VCARD_BIRTHDAY_DATA_H

#include "vcard_contact_data.h"

namespace OHOS {
namespace Telephony {
class VCardBirthdayData : public VCardContactData {
public:
    VCardBirthdayData()
    {
        birthday_ = "";
    ...
    void InitBirthdayData(std::string &birthday);
...
#endif // OHOS_VCARD_BIRTHDAY_DATA_H