...
#ifndef OHOS_VCARD_NOTE_DATA_H
#define OHOS_VCARD_NOTE_DATA_H

#include "vcard_contact_data.h"

namespace OHOS {
namespace Telephony {
class VCardNoteData : public VCardContactData {
public:
    VCardNoteData()
    {
        note_ = "";
    ...
    void InitNoteData(std::string note);
    std::string GetNote();
