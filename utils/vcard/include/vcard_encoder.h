...
private:
    std::shared_ptr<DataShare::DataShareResultSet> QueryContactData(const std::vector<int32_t> &rawContactIdList,
        int32_t &errorCode);
    void ProcessContactData(std::string &result, std::shared_ptr<DataShare::DataShareResultSet> contactDataResultSet,
        int32_t &errorCode);
