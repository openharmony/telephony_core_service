...
public:
    ...
    typedef int32_t (*GetDistributedSimCountFunc)(const std::string &bundleName, int32_t realSlotCout);
    ...
    int32_t GetDistributedSimCount(std::string &bundleName, int32_t realSlotCout);
