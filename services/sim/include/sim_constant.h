...
enum SimMessage {
    ...
    MSG_SIM_OBTAIN_SPN_CPHS_DONE,
    MSG_SIM_OBTAIN_SPN_SHORT_CPHS_DONE,
#ifdef CORE_SERVICE_SUPPORT_ESIM
    MSG_ESIM_OPEN_CHANNEL_DONE = 1000,
    ...
    MSG_ESIM_CLOSE_SPARE_CHANNEL_DONE,
    MSG_ESIM_GET_CONTRACT_INFO_DONE,
#endif
};
...
enum ControllerMessage {
    ...
    MSG_SIM_OBTAIN_INVALID_RECORD_OF_FIXED_ELEMENTARY_FILE_DONE = 8,
