...
private:
    ...
    ResultCode delProfile_ = ResultCode::RESULT_UNDEFINED_ERROR;
    ResultCode setDpAddressResult_ = ResultCode::RESULT_UNDEFINED_ERROR;
    ResultCode switchResult_ = ResultCode::RESULT_UNDEFINED_ERROR;
    ResultCode setNicknameResult_ = ResultCode::RESULT_UNDEFINED_ERROR;
    ResultCode resetResult_ = ResultCode::RESULT_UNDEFINED_ERROR;
    ResultCode disableProfileResult_ = ResultCode::RESULT_UNDEFINED_ERROR;
    ResultCode factoryResetResult_ = ResultCode::RESULT_UNDEFINED_ERROR;
    ResultCode removeNotifResult_ = ResultCode::RESULT_UNDEFINED_ERROR;
