...
private:
    ...
    int32_t delProfile_ = static_cast<int32_t>(ResultCode::RESULT_SGP_22_OTHER);
    int32_t setDpAddressResult_ = static_cast<int32_t>(ResultCode::RESULT_SGP_22_OTHER);
    int32_t switchResult_ = static_cast<int32_t>(ResultCode::RESULT_SGP_22_OTHER);
    int32_t setNicknameResult_ = static_cast<int32_t>(ResultCode::RESULT_SGP_22_OTHER);
    int32_t resetResult_ = static_cast<int32_t>(ResultCode::RESULT_SGP_22_OTHER);
    ...
    int32_t removeNotifResult_ = static_cast<int32_t>(ResultCode::RESULT_SGP_22_OTHER);
