...
public:
    ...
    ResponseEsimResult CancelSession(std::u16string transactionId, CancelReason cancelReason);
    EuiccProfile ObtainProfile(int32_t portIndex, std::u16string iccId);
