    ...
    int32_t fileId, const std::string &data, const std::string &path, SimAuthenticationResponse &response)
{
    ...
    requestInfo.p1 = static_cast<int>(strtol(data.substr(SIM_IO_DATA_P1_OFFSET, SIM_IO_DATA_STR_LEN).c_str(), nullptr, SIM_IO_HEX_SIGN));
    requestInfo.p2 = static_cast<int>(strtol(data.substr(SIM_IO_DATA_P2_OFFSET, SIM_IO_DATA_STR_LEN).c_str(), nullptr, SIM_IO_HEX_SIGN));
    requestInfo.p3 = static_cast<int>(strtol(data.substr(SIM_IO_DATA_P3_OFFSET, SIM_IO_DATA_STR_LEN).c_str(), nullptr, SIM_IO_HEX_SIGN));
