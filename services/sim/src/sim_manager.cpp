...
{
    if (iccId.empty() || labelIndex < SIM_LABEL_INDEX_MIN || labelIndex > SIM_LABEL_INDEX_MAX) {
...
int32_t SimManager::SetTargetPrimarySlotId(bool isDualCard, int32_t primarySlotId)
{
    if (multiSimController_ == nullptr) {
