    ...
    int32_t slotId, const ImsServiceStatus &imsServiceStatus)
{
    ...
    return SendRequest(in, slotId, static_cast<int32_t>(ImsCoreServiceInterfaceCode::IMS_SERVICE_STATUS_REPORT));
}
    ...
    int32_t slotId, const ImsRegistrationStatus &imsRegStatus)
{
    ...
    return SendRequest(in, slotId, static_cast<int32_t>(ImsCoreServiceInterfaceCode::IMS_GET_REGISTRATION_STATUS));
}
