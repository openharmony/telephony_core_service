...
void TelRilBase::ResetRilInterface(sptr<HDI::Ril::V1_0::IRilInterface> rilInterface)
{
...
int32_t TelRilBase::TelRilOnlyReportResponseInfo(const HDI::Ril::V1_0::IHRilRadioResponseInfo &responseInfo)
{
