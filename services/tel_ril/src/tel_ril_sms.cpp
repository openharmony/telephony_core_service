...
HDI::Ril::V1_0::IGsmSmsMessageInfo TelRilSms::ConstructGsmSendSmsRequestLinkList(std::string &smsPdu, std::string &pdu)
{
    HDI::Ril::V1_0::IGsmSmsMessageInfo msg;
    msg.smscPdu = smsPdu.empty() ? "" : smsPdu;
    msg.pdu = pdu.empty() ? "" : pdu;
    return msg;
}

OHOS::HDI::Ril::V1_0::ISmsMessageIOInfo TelRilSms::ConstructSmsMessageIOInfoRequestLinkList(
    std::string &smsPdu, std::string &pdu)
{
    OHOS::HDI::Ril::V1_0::ISmsMessageIOInfo msg;
    msg.smscPdu = smsPdu.empty() ? "" : smsPdu;
    msg.pdu = pdu.empty() ? "" : pdu;
    return msg;
}
...
{
    HDI::Ril::V1_0::IGsmSmsMessageInfo gsmSmsMessageInfo = ConstructGsmSendSmsRequestLinkList(smsPdu, pdu);
    return Request(TELEPHONY_LOG_FUNC_NAME, response, HREQ_SMS_SEND_GSM_SMS, &HDI::Ril::V1_0::IRilInterface::SendGsmSms,
        gsmSmsMessageInfo);
}

int32_t TelRilSms::SendCdmaSms(std::string pdu, const AppExecFwk::InnerEvent::Pointer &response)
{
    HDI::Ril::V1_0::ISendCdmaSmsMessageInfo cdmaSmsMessageInfo = {};
    cdmaSmsMessageInfo.smscPdu = pdu;
    return Request(TELEPHONY_LOG_FUNC_NAME, response, HREQ_SMS_SEND_CDMA_SMS,
        &HDI::Ril::V1_0::IRilInterface::SendCdmaSms, cdmaSmsMessageInfo);
}
...
{
    OHOS::HDI::Ril::V1_0::ISmsMessageIOInfo mGsmSmsMessageInfo = ConstructSmsMessageIOInfoRequestLinkList(smscPdu, pdu);
    mGsmSmsMessageInfo.state = status;
    return Request(TELEPHONY_LOG_FUNC_NAME, response, HREQ_SMS_ADD_SIM_MESSAGE,
        &HDI::Ril::V1_0::IRilInterface::AddSimMessage, mGsmSmsMessageInfo);
}

int32_t TelRilSms::DelSimMessage(int32_t gsmIndex, const AppExecFwk::InnerEvent::Pointer &response)
{
    return Request(TELEPHONY_LOG_FUNC_NAME, response, HREQ_SMS_DEL_SIM_MESSAGE,
        &HDI::Ril::V1_0::IRilInterface::DelSimMessage, gsmIndex);
}
...
{
    OHOS::HDI::Ril::V1_0::ISmsMessageIOInfo smsMessageIOInfo = ConstructSmsMessageIOInfoRequestLinkList(smscPdu, pdu);
    ...
    return Request(TELEPHONY_LOG_FUNC_NAME, response, HREQ_SMS_UPDATE_SIM_MESSAGE,
        &HDI::Ril::V1_0::IRilInterface::UpdateSimMessage, smsMessageIOInfo);
}

int32_t TelRilSms::SetSmscAddr(int32_t tosca, std::string address, const AppExecFwk::InnerEvent::Pointer &response)
{
    OHOS::HDI::Ril::V1_0::IServiceCenterAddress serCenterAddress;
    serCenterAddress.address = address;
    serCenterAddress.tosca = tosca;
    return Request(TELEPHONY_LOG_FUNC_NAME, response, HREQ_SMS_SET_SMSC_ADDR,
        &HDI::Ril::V1_0::IRilInterface::SetSmscAddr, serCenterAddress);
}

int32_t TelRilSms::GetSmscAddr(const AppExecFwk::InnerEvent::Pointer &response)
{
    return Request(
        TELEPHONY_LOG_FUNC_NAME, response, HREQ_SMS_GET_SMSC_ADDR, &HDI::Ril::V1_0::IRilInterface::GetSmscAddr);
}

int32_t TelRilSms::GetCdmaCBConfig(const AppExecFwk::InnerEvent::Pointer &response)
{
    return Request(TELEPHONY_LOG_FUNC_NAME, response, HREQ_SMS_GET_CDMA_CB_CONFIG,
        &HDI::Ril::V1_0::IRilInterface::GetCdmaCBConfig);
}

int32_t TelRilSms::SendSmsMoreMode(
    std::string &smscPdu, std::string &pdu, const AppExecFwk::InnerEvent::Pointer &response)
{
    HDI::Ril::V1_0::IGsmSmsMessageInfo gsmSmsMessageInfo = ConstructGsmSendSmsRequestLinkList(smscPdu, pdu);
    return Request(TELEPHONY_LOG_FUNC_NAME, response, HREQ_SMS_SEND_SMS_MORE_MODE,
        &HDI::Ril::V1_0::IRilInterface::SendSmsMoreMode, gsmSmsMessageInfo);
}

int32_t TelRilSms::SendSmsAck(bool success, int32_t cause, const AppExecFwk::InnerEvent::Pointer &response)
{
    HDI::Ril::V1_0::IModeData mModeData;
    mModeData.result = success;
    mModeData.mode = cause;
    return Request(TELEPHONY_LOG_FUNC_NAME, response, HREQ_SMS_SEND_SMS_ACK, &HDI::Ril::V1_0::IRilInterface::SendSmsAck,
        mModeData);
}
    ...
    CdmaCBConfigInfoList &cdmaCBConfigInfoList, const AppExecFwk::InnerEvent::Pointer &response)
{
    ...
    return Request(TELEPHONY_LOG_FUNC_NAME, response, HREQ_SMS_SET_CDMA_CB_CONFIG,
        &HDI::Ril::V1_0::IRilInterface::SetCdmaCBConfig, iCdmaCBConfigInfoList);
}

int32_t TelRilSms::GetCBConfig(const AppExecFwk::InnerEvent::Pointer &response)
{
    return Request(
        TELEPHONY_LOG_FUNC_NAME, response, HREQ_SMS_GET_CB_CONFIG, &HDI::Ril::V1_0::IRilInterface::GetCBConfig);
}

int32_t TelRilSms::AddCdmaSimMessage(int32_t status, std::string &pdu, const AppExecFwk::InnerEvent::Pointer &response)
{
    OHOS::HDI::Ril::V1_0::ISmsMessageIOInfo mSmsMessageIOInfo = {};
    ...
    return Request(TELEPHONY_LOG_FUNC_NAME, response, HREQ_SMS_ADD_CDMA_SIM_MESSAGE,
        &HDI::Ril::V1_0::IRilInterface::AddCdmaSimMessage, mSmsMessageIOInfo);
}
...
int32_t TelRilSms::DelCdmaSimMessage(int32_t cdmaIndex, const AppExecFwk::InnerEvent::Pointer &response)
{
    return Request(TELEPHONY_LOG_FUNC_NAME, response, HREQ_SMS_DEL_CDMA_SIM_MESSAGE,
        &HDI::Ril::V1_0::IRilInterface::DelCdmaSimMessage, cdmaIndex);
}
...
{
    OHOS::HDI::Ril::V1_0::ISmsMessageIOInfo smsMessageIOInfo = {};
    ...
    return Request(TELEPHONY_LOG_FUNC_NAME, response, HREQ_SMS_UPDATE_CDMA_SIM_MESSAGE,
        &HDI::Ril::V1_0::IRilInterface::UpdateCdmaSimMessage, smsMessageIOInfo);
}
...
int32_t TelRilSms::NewSmsNotify(const HDI::Ril::V1_0::ISmsMessageInfo &iSmsMessageInfo)
{
...
int32_t TelRilSms::NewCdmaSmsNotify(const HDI::Ril::V1_0::ISmsMessageInfo &iSmsMessageInfo)
{
    std::shared_ptr<SmsMessageInfo> smsMessageInfo = std::make_shared<SmsMessageInfo>();
    if (smsMessageInfo == nullptr) {
        TELEPHONY_LOGE("ERROR : smsMessageInfo == nullptr !!!");
...
int32_t TelRilSms::SmsStatusReportNotify(const HDI::Ril::V1_0::ISmsMessageInfo &iSmsMessageInfo)
{
    std::shared_ptr<SmsMessageInfo> smsMessageInfo = std::make_shared<SmsMessageInfo>();
    if (smsMessageInfo == nullptr) {
        TELEPHONY_LOGE("ERROR : smsMessageInfo == nullptr !!!");
...
int32_t TelRilSms::CBConfigNotify(const HDI::Ril::V1_0::ICBConfigReportInfo &iCellBroadConfigReportInfo)
{
...
int32_t TelRilSms::SendGsmSmsResponse(const HDI::Ril::V1_0::IHRilRadioResponseInfo &responseInfo,
    const HDI::Ril::V1_0::ISendSmsResultInfo &iSendSmsResultInfo)
{
    return ResponseSendSms(responseInfo, iSendSmsResultInfo);
}

int32_t TelRilSms::SendCdmaSmsResponse(const HDI::Ril::V1_0::IHRilRadioResponseInfo &responseInfo,
    const HDI::Ril::V1_0::ISendSmsResultInfo &iSendSmsResultInfo)
{
    return ResponseSendSms(responseInfo, iSendSmsResultInfo);
}

int32_t TelRilSms::AddSimMessageResponse(const HDI::Ril::V1_0::IHRilRadioResponseInfo &responseInfo)
{
    return Response(TELEPHONY_LOG_FUNC_NAME, responseInfo);
}

int32_t TelRilSms::DelSimMessageResponse(const HDI::Ril::V1_0::IHRilRadioResponseInfo &responseInfo)
{
    return Response(TELEPHONY_LOG_FUNC_NAME, responseInfo);
}

int32_t TelRilSms::UpdateSimMessageResponse(const HDI::Ril::V1_0::IHRilRadioResponseInfo &responseInfo)
{
    return Response(TELEPHONY_LOG_FUNC_NAME, responseInfo);
}

int32_t TelRilSms::SetSmscAddrResponse(const HDI::Ril::V1_0::IHRilRadioResponseInfo &responseInfo)
{
    return Response(TELEPHONY_LOG_FUNC_NAME, responseInfo);
}

int32_t TelRilSms::GetSmscAddrResponse(const HDI::Ril::V1_0::IHRilRadioResponseInfo &responseInfo,
...
int32_t TelRilSms::GetCBConfigResponse(
    const HDI::Ril::V1_0::IHRilRadioResponseInfo &responseInfo, const HDI::Ril::V1_0::ICBConfigInfo &iCellBroadcastInfo)
{
...
int32_t TelRilSms::GetCdmaCBConfigResponse(const HDI::Ril::V1_0::IHRilRadioResponseInfo &responseInfo,
...
int32_t TelRilSms::SendSmsMoreModeResponse(const HDI::Ril::V1_0::IHRilRadioResponseInfo &responseInfo,
    const HDI::Ril::V1_0::ISendSmsResultInfo &iSendSmsResultInfo)
{
    return ResponseSendSms(responseInfo, iSendSmsResultInfo);
}

int32_t TelRilSms::SendSmsAckResponse(const HDI::Ril::V1_0::IHRilRadioResponseInfo &responseInfo)
{
    return Response(TELEPHONY_LOG_FUNC_NAME, responseInfo);
}

int32_t TelRilSms::SetCBConfigResponse(const HDI::Ril::V1_0::IHRilRadioResponseInfo &responseInfo)
{
    return Response(TELEPHONY_LOG_FUNC_NAME, responseInfo);
}

int32_t TelRilSms::SetCdmaCBConfigResponse(const HDI::Ril::V1_0::IHRilRadioResponseInfo &responseInfo)
{
    return Response(TELEPHONY_LOG_FUNC_NAME, responseInfo);
}

int32_t TelRilSms::AddCdmaSimMessageResponse(const HDI::Ril::V1_0::IHRilRadioResponseInfo &responseInfo)
{
    return Response(TELEPHONY_LOG_FUNC_NAME, responseInfo);
}

int32_t TelRilSms::DelCdmaSimMessageResponse(const HDI::Ril::V1_0::IHRilRadioResponseInfo &responseInfo)
{
    return Response(TELEPHONY_LOG_FUNC_NAME, responseInfo);
}

int32_t TelRilSms::UpdateCdmaSimMessageResponse(const HDI::Ril::V1_0::IHRilRadioResponseInfo &responseInfo)
{
    return Response(TELEPHONY_LOG_FUNC_NAME, responseInfo);
}

void TelRilSms::BuildSendSmsResultInfo(
    std::shared_ptr<SendSmsResultInfo> sendSmsResultInfo, const HDI::Ril::V1_0::ISendSmsResultInfo &iSendSmsResultInfo)
{
