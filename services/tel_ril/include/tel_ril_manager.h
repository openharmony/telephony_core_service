...
public:
    ...
    int32_t GetNeighboringCellInfoList(int32_t slotId, const AppExecFwk::InnerEvent::Pointer &response) override;
    ...
    int32_t SimOpenLogicalChannel(int32_t slotId, const std::string &appID, const int32_t p2,
        const AppExecFwk::InnerEvent::Pointer &response) override;
    int32_t SimOpenLogicalChannelWithPort(int32_t slotId, const std::string &appID, const int32_t p2,
        int32_t portIndex, const AppExecFwk::InnerEvent::Pointer &response) override;
